...
CKPT_ARGS=(
   ...
   --load "${BASE_FOLDER}/Qwen3.5-4B_slime_ppo/"
   --save "${BASE_FOLDER}/Qwen3.5-4B_slime_ppo/"
   --save-interval 1
)
...
PPO_ARGS=(
   ...
   --clip-epsilon 0.2              # PPO clip ratio, 对应 GRPO eps-clip
   --entropy-coef 0.01             # 可根据实验调节
   --vf-coef 0.5                   # value function loss coefficient
   --kl-coef 0.0                    # 可选，用于控制策略漂移
